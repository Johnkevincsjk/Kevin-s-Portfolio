    ...
    return (
        ...
        <div initial={{ opacity: 0, scaleX: 0 }}
            ...
            <motion.div className=' col self1'
                ...
                <a href='https://drive.google.com/file/d/1YXNzeezlENtZvs3mMdtUneHzTFOuJihp/view?usp=sharing' target='_blank'><motion.button initial={{ scale: 1 }} transition={{ duration: 0.2, type: 'spring', stiffness: 700 }} whileHover={{ scale: 1.1 }}>Download Resume</motion.button></a> {/* Resume is placed here */}
            </motion.div>
